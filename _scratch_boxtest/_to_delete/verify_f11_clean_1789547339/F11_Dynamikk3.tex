    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}
        \node[anchor=south west, inner sep=0] (image) at (0,0) {%
          \ifdarkmode\includegraphics[width=5.6cm]{Images/Dashman_slede_fjaer_skraplan_mork.png}\else\includegraphics[width=5.6cm]{Kapittel4:Dynamikk/Dashman_slede_fjaer_skraplan.png}\fi%
        };
...
\begin{frame}{Skråplan}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.54\textwidth}
      ...
      \[
        N = m\mathrm{g}\cos\theta,\qquad m\mathrm{g}\sin\theta - R_k = ma
      \]
    \end{column}
  \end{columns}
...
\begin{frame}{Kritisk vinkel}
  ...
  \[
    m\mathrm{g}\sin\theta_c - \mu_s m\mathrm{g}\cos\theta_c = 0 \quad\Longrightarrow\quad \tan\theta_c = \mu_s
  \]
