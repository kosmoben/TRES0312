...
\begin{frame}{}
  ...
  \repetisjon{Tre kjappe fra forrige gang}{%
    \begin{enumerate}[1.]
      \item Hva blir normalkraften $N$ på en kloss på et skråplan med helningsvinkel $\theta$, uttrykt ved $m$, $\mathrm{g}$ og $\theta$?
      \item Skriv opp algoritmens fem steg for å løse sammensatte kraftoppgaver.
