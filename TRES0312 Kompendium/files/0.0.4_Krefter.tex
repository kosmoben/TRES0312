...
\begin{tikzpicture}[font=\small]
  ...
  % Snorer: fra knutepunkt (0,0.80) til takfeste
  % alpha=30 fra horisontal: retning (-cos30,sin30)=(-0.866,0.5)
  % Lengde 1.14: endepkt (-0.987,1.37)... juster til y=1.78:
  % Deltay=1.78-0.80=0.98, deltax=0.98/tan30=0.98*sqrt3=1.697
  % Venstre: (0-1.697, 0.80+0.98)=(−1.697,1.78) ✓
  % Høyre: (1.697, 1.78)
  ...
  % Koordinatsystem ved knutepunkt
  \draw[-{Stealth[length=8pt,width=5pt]},black!70,semithick]
    (0,0.80) -- (0.75,0.80);
  ...
  % S1: fra knutepunkt opp-venstre (-cos30,sin30)=(-0.866,0.5), lengde 0.90
  % Tupp: (-0.779, 1.25)
  \draw[-{Stealth[length=11pt,width=7pt]}, line width=2.5pt, defscol]
    (0,0.80) -- (-0.779,1.25);
  \node[left=4pt,defscol,font=\small\bfseries,fill=white,draw=defscol,
  ...
  % S2: fra knutepunkt opp-høyre (cos30,sin30)=(0.866,0.5), lengde 0.90
  % Tupp: (0.779, 1.25)
  \draw[-{Stealth[length=11pt,width=7pt]}, line width=2.5pt, defscol]
    (0,0.80) -- (0.779,1.25);
...
\[\frac{\vec{p}}{\Delta t}=\vec{F}\quad\text{som medfører}\quad \Delta\vec{p}=\vec{F}\Delta t.\]
Dette viser at kraft gjort over tid gir endring i bevegelsesmengde. For dere som kan å integrere, ser vi altså at \textit{integralet} av kraft over tid er bevegelsesmengde. Dette gir mening. Når en kraft virker på et legeme over tid, så endrer det bevegelsesmengden til legemet. Endring i bevegelsesmengde forårsaket av et kraftstøt har faktisk et eget navn. Vi kaller det for \textit{impuls}. I dette faget skal vi riktignok ikke bruke dette begrepet noe videre.
