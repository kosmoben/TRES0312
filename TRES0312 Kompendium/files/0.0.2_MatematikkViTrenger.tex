...
\[
\bar{v} = \frac{s_{\text{total}}}{t_{\text{total}}} = \frac{9\ \textrm{km}}{38\ \textrm{min}} = \doubleunderline{0.237\ \textrm{km/min}} = 0.237\cdot\frac{1\,000\ \textrm{m}}{60\ \textrm{s}} = \doubleunderline{3.95\ \textrm{m/s}}.
\]
...
\[
a = \frac{F}{m} = \frac{4\,800\ \textrm{N}}{1\,200\ \textrm{kg}} = \doubleunderline{4.0\ \textrm{m/s}^2}.
\]
}
...
En ball kastes med fart $v = 20\,\textrm{m/s}$ i en vinkel $\theta = 37°$ over horisonten
($\cos 37° \approx 0{,}80$, $\sin 37° \approx 0{,}60$).\\
\textbf{a)} Finn komponentene $v_x$ og $v_y$.\\
\textbf{b)} Verifiser at $|\vec{v}| = \sqrt{v_x^2 + v_y^2} = 20\,\textrm{m/s}$.}

\svar{%
\textbf{a)} Vi bruker de trigonometriske relasjonene $v_x = v\cos\theta$ og $v_y = v\sin\theta$:
\[
v_x = 20\,\textrm{m/s}\cdot 0{,}80 = \doubleunderline{16\,\textrm{m/s}},
\qquad
v_y = 20\,\textrm{m/s}\cdot 0{,}60 = \doubleunderline{12\,\textrm{m/s}}.
\]
\textbf{b)} Pythagoras bekrefter:
\[
\sqrt{v_x^2 + v_y^2} = \sqrt{(16\,\textrm{m/s})^2 + (12\,\textrm{m/s})^2}
= \sqrt{256 + 144}\,\textrm{m/s} = \sqrt{400}\,\textrm{m/s} = \doubleunderline{20\,\textrm{m/s}}\;\checkmark
\]
}
...
\begin{enumerate}[a)]
    ...
    \item En fugl flyr $10\ \textrm{km}$ i retning N$60^\circ$Ø (det vil si $60^\circ$ øst for nord). Finn de nord- og østkomponentene til forskyvningsvektoren. \textit{Hint:} Vinkelen er målt fra nordaksen, ikke fra østaksen.
