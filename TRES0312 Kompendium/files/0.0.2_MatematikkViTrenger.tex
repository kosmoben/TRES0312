...
I mange lærebøker brukes symbolene $\mathbf{i}$, $\mathbf{j}$, $\mathbf{k}$ for de samme enhetsvektorene. I dette kompendiet bruker vi $\hat{\mathbf{x}}$, $\hat{\mathbf{y}}$ (og $\hat{z}$ i tre dimensjoner), da denne notasjonen gjør det umiddelbart tydelig hvilken retning enhetsvektoren peker i.
\end{mymerk*}

\paragraph{Notasjon for vektorer}
