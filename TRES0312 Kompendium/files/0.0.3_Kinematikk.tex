...
\begin{tikzpicture}[font=\small, scale=1.15, >=stealth]
  ...
  % Chord Δr (P1 → P2, horizontal since symmetric about 90°)
  \draw[->, oppsumcol, thick, dashed] (P1) -- (P2)
        node[midway, above=4pt] {$\Delta r$};
...
\textbf{Høyre:} Hastighetstrekanten (vektorene lagt hale mot hale). De to trekantene er formlike med samme toppvinkel $\Delta\theta$ og forholdssidene $r$ og $v$, slik at $\Delta v/v = \Delta r/r$.}
...
For å finne størrelsen på momentanakselerasjonen så må vi la \( \Delta t \to 0 \). Vi finner da 
