...
\svar{
Fartskomponentene er $v_\textrm{nord} = 4\,\textrm{m/s}$ og $v_\textrm{øst} = 3\,\textrm{m/s}$.
Siden de to komponentene er vinkelrette, finner vi totalfarten med Pythagoras:
\[
  |\vec{v}| = \sqrt{v_\textrm{nord}^2 + v_\textrm{øst}^2}
            = \sqrt{4^2 + 3^2}
            = \sqrt{16 + 9}
            = \sqrt{25}
            = \doubleunderline{5\,\textrm{m/s}}
\]
Dette er det samme $3$-$4$-$5$-trekantforholdet som dukket opp i eksempel 3.2: avstanden $|\vec{\Delta s}_{PR}| = 5\,\textrm{km}$ der. Begge situasjoner er geometrisk identiske – bare med ulike størrelser og enheter.
}
...
\end{minipage}%
%=== SKILLELINJE ==========================================================
\hspace{4pt}{\color{black!25}\rule[-13cm]{0.4pt}{14.5cm}}\hspace{4pt}%
