...
\begin{enumerate}
    ...
    \item En nettleser åpnes. Naviger til mappen \texttt{Python eksempler} og åpne en av \texttt{.ipynb}-filene.
    \item Klikk på en kodecelle og trykk \textbf{Shift+Enter} for å kjøre den.
\end{enumerate}

\begin{mymerk*}{Alle eksempler er klare til bruk}
Alle kodeeksemplene fra dette kompendiet finnes som ferdige Jupyter Notebook-filer i mappen \texttt{Python eksempler}. Du kan åpne dem direkte og kjøre dem uten å skrive noe selv — og deretter modifisere dem for å eksperimentere.
\end{mymerk*}
