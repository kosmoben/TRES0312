...
\begin{minipage}[t]{0.55\linewidth}
  ...
  \begin{enumerate}[\textbf{a)}]
    ...
    \item Selv om båt 2 hadde ulik fart på de to etappene (3 og $\SI{4}{\kilo\metre\per\hour}$), er den totale gjennomsnittsfarten identisk med båt 1. Gjennomsnittsfart avhenger kun av total forflytning og total tid – ikke av hvordan farten varierte underveis. Dette viser at begrepet gjennomsnittsfart er av begrenset interesse. Gjennomsnittsfarten til en sprinter som løper 100 meter én vei og så 100 meter tilbake er med den samme logikken lik 0! Frem og tilbake er like langt...
  \end{enumerate}
\end{minipage}%
\hfill
