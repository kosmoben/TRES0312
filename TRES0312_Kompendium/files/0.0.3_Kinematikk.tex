...
\begin{tikzpicture}[font=\small, scale=1.0, >=stealth]
  ...
  \draw[->, very thick, defscol] (3.538, 2.525) -- (4.405, 2.282)
        node[above right=2pt] {$\vec{v}(t_2)$};
...
En båt beveger seg med fart $v=5.0$ knopp i Nord-Østlig retning.
\begin{enumerate}[a)]
    \item Finn farta i nordlig retning ($v_\text{N}$) og farta i østlig retning ($v_\text{Ø}$).
    \item Oppgi farten $v$ i km/h. (Én knop er definert som $1.852$ km/h.)
\end{enumerate}
}
