...
\input{Oppgaver/k2_oppg01.tex}%
}
\begin{mymerk*}{}
Om du ikke kjenner til formlene vi her har brukt, som $F=ma$, $E_K = \frac{1}{2}mv^2$ og $E_p = m\mathrm{g}h$, så er det ikke noe problem. Vi kommer tilbake til det i senere kapitler. Det viktigste akkurat nå er at du har kontroll på algebaraen.
\end{mymerk*}
...
I fysikken må vi ofte sette opp flere likninger for å beskrive en situasjon riktig. For å finne det vi er ute etter, må vi da gjerne løse et \emph{likningssystem} — altså flere likninger med flere ukjente. Vi kommer tilbake til dette i senere kapitler, men her er et eksempel på hvordan man kan løse et slikt system.

\exm{Redningsbil drar en bil}{%
En redningsbil drar en bil som i utgangspunktet står i ro, med en konstant kraft $F = \SI{3000}{\newton}$ i horisontal retning. Massen til bilen er $m = \SI{1200}{\kilo\gram}$. Hva er farten $v$ til bilen etter $t = \SI{5}{\second}$?
}
...
\end{cases}
\]
Vi løser systemet med innsettingsmetoden. Fra den første likningen finner vi et \emph{uttrykk} for akselerasjonen — vi setter ikke inn tall ennå:
\[
a = \frac{F}{m}.
\]
...
\[
v = \frac{\SI{3000}{\newton}}{\SI{1200}{\kilo\gram}} \cdot \SI{5}{\second} = \doubleunderline{\SI{12.5}{\metre\per\second}}.
\]
}

\begin{mymerk*}{}
Legg merke til fremgangsmåten: vi satte opp \emph{to} likninger — én fra kraft og masse, én fra kinematikken — og kombinerte dem til ett generelt \emph{uttrykk} for $v$, \emph{før} vi satte inn tallverdier. Det lønner seg å venne seg til denne rekkefølgen: finn uttrykket for det du er ute etter først, og regn ut svaret med tall helt til slutt.
\end{mymerk*}

\oppgaver{Per og Kari}{k2oppg2}{%
\input{Oppgaver/k2_oppg02.tex}%
}
...
\oppgaver{Trigonometri}{k2oppg4}{%
\input{Oppgaver/k2_oppg04.tex}%
}

\section{Vektorer}
\begin{wrapfigure}[6]{r}[1.5cm]{3.6cm}
\vspace{-\baselineskip}%
\rotatebox{-15}{\href{https://youtu.be/c3yv7fgCnwA?si=K4Tnol66FJYiIh5d}{%
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_VektorerIPlanet.png}};
...
\oppgaver{Skalarer og vektorer}{k2oppg5}{%
\input{Oppgaver/k2_oppg05.tex}%
}
...
\oppgaver{Koordinatsystem}{k2oppg6}{%
\input{Oppgaver/k2_oppg06.tex}%
}
...
\oppgaver{Vektorer som en lineærkombinasjon av enhetsvektorer}{k2oppg7}{%
\input{Oppgaver/k2_oppg07.tex}%
}
  ...
  \begin{enumerate}[\textbf{\alph*)}]
    ...
    \item Vinkelen kan beregnes på tre ekvivalente måter:
          \[\sin\theta = \frac{A_y}{A} = \frac{4}{5}
            \;\Rightarrow\;
            \theta = \arcsin\!\tfrac{4}{5} \approx \doubleunderline{53.1°}\]
...
\oppgaver{Dekomponering av vektorer}{k2oppg8}{%
\input{Oppgaver/k2_oppg08.tex}%
}
...
\oppgaver{Størrelse og retning}{k2oppg9}{%
\input{Oppgaver/k2_oppg09.tex}%
}
...
\oppgaver{Vektoraddisjon}{k2oppg10}{%
\input{Oppgaver/k2_oppg10.tex}%
}
...
\oppgaver{Skalarprodukt}{k2oppg11}{%
\input{Oppgaver/k2_oppg11.tex}%
}


\subsection*{Multiplikasjon av vektorer: kryssproduktet}
Kryssprodukt (engelsk: \textit{cross product}) er en operasjon mellom to vektorer som gir en ny vektor vinkelrett på begge. I to dimensjoner reduseres kryssproduktet til et enkelt tall — z-komponenten — som blant annet brukes til å beregne dreiemoment og areal av parallelogrammer. Egentlig defineres kryssproduktet kun i tre dimensjoner, men vi kan bruke det i to dimensjoner ved å anta at vektorene ligger i xy-planet, og at kryssproduktet peker i z-retning.

\defn{Kryssprodukt i 2D}{For to vektorer $\vec{u} = [u_x,\, u_y]$ og $\vec{v} = [v_x,\, v_y]$ i $xy$-planet peker kryssproduktet i $z$-retning, med størrelse 
\begin{align}
...
\oppgaver{Kryssprodukt}{k2oppg12}{%
\input{Oppgaver/k2_oppg12.tex}%
}
...
\oppgaver{Trigonometri og vektorkomponenter}{k2oppg13}{%
\input{Oppgaver/k2_oppg13.tex}%
}

\oppgaver{Vektorer og skalarprodukt}{k2oppg14}{%
\input{Oppgaver/k2_oppg14.tex}%
}

\oppgaver{Parallell og vinkelrett}{k2oppg15}{%
\input{Oppgaver/k2_oppg15.tex}%
}

\oppgaver{Areal med kryssprodukt}{k2oppg16}{%
\input{Oppgaver/k2_oppg16.tex}%
}
