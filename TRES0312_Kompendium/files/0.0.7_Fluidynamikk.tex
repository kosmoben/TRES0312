...
Trykkkraften \emph{ned} på toppen er $F_{\text{topp}} = p_1 \cdot A = (\rho_v \mathrm{g} h_1)\,A$,
og kraften \emph{opp} på bunnen er $F_{\text{bunn}} = p_2 \cdot A = (\rho_v \mathrm{g} h_2)\,A$.
Nettokraften oppover er:
\[
  O = F_{\text{bunn}} - F_{\text{topp}}
    = \rho_v \mathrm{g} A (h_2 - h_1)
    = \rho_v \mathrm{g} A h_s
    = \rho_v \mathrm{g} V_{\text{fortrengt}}
\]
...
\[
  F_{\text{netto}} = O - G = \rho_v \mathrm{g} V - \rho_L \mathrm{g} V = (\rho_v - \rho_L)\,\mathrm{g} V
\]
...
\[
O = \rho_B \mathrm{g} V_q = 1000 \cdot 9.81 \cdot 1.08 = 10594.8 \, \text{N}.
\]
Rundt av til:
\[
O \approx 11 \, \text{kN}.
...
Løs for massen \( m \):
\[
m = \frac{O}{\mathrm{g}} = \frac{10594.8}{9.81} \approx 1080 \, \text{kg}.
\]
