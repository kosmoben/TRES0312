...
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_NewtonsTredjeLov.png}};
...
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_NewtonsAndreLov.png}};
\node[anchor=north west] at (thumb.south west) {\includegraphics[width=1.2cm]{Images/YouTubeLenker/Icon.png}};
\end{tikzpicture}%
}}%
\end{wrapfigure}
...
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_NewtonsForsteLov.png}};
\node[anchor=north west] at (thumb.south west) {\includegraphics[width=1.2cm]{Images/YouTubeLenker/Icon.png}};
\end{tikzpicture}%
}}%
\end{wrapfigure}
...
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_Skraplanet.png}};
\node[anchor=north west] at (thumb.south west) {\includegraphics[width=1.2cm]{Images/YouTubeLenker/Icon.png}};
\end{tikzpicture}%
}}%
\end{wrapfigure}
...
\begin{figure}[ht!]
    ...
    \caption{Krefter på en kloss som sklir nedover et skråplan. Normalkraften $\vec{N}$ peker normalt ut fra planet, tyngdekraften $\vec{G}$ peker rett ned, og friksjonskraften $\vec{R}$ peker opp langs planet siden klossen beveger seg ned.}
...
\textbf{4. Dekomponér:}
\begin{align*}
    \sum F_{y'} = 0 &:\quad N - m\mathrm{g}\cos\theta = 0 \implies N = m\mathrm{g}\cos\theta\\
    \sum F_{x'} = ma &:\quad m\mathrm{g}\sin\theta - R = ma
\end{align*}
...
\textbf{4. Dekomponér:}
\begin{align*}
    \sum F_{y'} = 0&:\quad N - G\cos\theta = 0 \implies N = m\mathrm{g}\cos\theta\\
    \sum F_{x'} = 0&:\quad kx + R_s - G\sin\theta = 0
\end{align*}

\smallskip\noindent
\textbf{5. Løs:} Sett inn $R_s = \mu_s N = \mu_s m\mathrm{g}\cos\theta$:
\[
