...
\begin{tikzpicture}
  ...
  \begin{scope}[x={(image.south east)}, y={(image.north west)}]
    \node[anchor=north, font=\bfseries\large, text=dashblue] at (0.710, 0.035) {$G = mg$};
  \end{scope}
\end{tikzpicture}
\caption{Dash-Line påvirkes av en kraft med størrelse $G=mg$ fra jorda. Dashman ser ut til å være påvirket av helt andre former for tiltrekningskrefter... ;)}
