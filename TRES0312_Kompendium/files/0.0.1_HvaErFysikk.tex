...
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_HvaErFysikk.png}};
...
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_HvaErMekanikk.png}};
\node[anchor=north west] at (thumb.south west) {\includegraphics[width=1.2cm]{Images/YouTubeLenker/Icon.png}};
\end{tikzpicture}%
}}%
\end{wrapfigure}
...
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_EnheterIFysikk.png}};
\node[anchor=north west] at (thumb.south west) {\includegraphics[width=1.2cm]{Images/YouTubeLenker/Icon.png}};
\end{tikzpicture}%
}}%
\end{wrapfigure}
...
\input{Oppgaver/k1_oppg02.tex}%
}

\oppgaver{Enhetsregning}{enhetsregning}{%
\input{Oppgaver/k1_oppg03.tex}%
}
...
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_SignifikanteSifferAvrunding.png}};
\node[anchor=north west] at (thumb.south west) {\includegraphics[width=1.2cm]{Images/YouTubeLenker/Icon.png}};
\end{tikzpicture}%
}}%
\end{wrapfigure}
...
\begin{tikzpicture}[inner sep=0pt]
\node[anchor=south west] (thumb) at (0,0) {\includegraphics[width=3.6cm]{Images/YouTubeLenker/YT_DekadiskePrefikserStandardform.png}};
\node[anchor=north west] at (thumb.south west) {\includegraphics[width=1.2cm]{Images/YouTubeLenker/Icon.png}};
\end{tikzpicture}%
}}%
\end{wrapfigure}
...
\input{Oppgaver/k1_oppg07.tex}%
}

\oppgaver{Dekadiske prefikser -- matching}{k1oppg8}{%
\input{Oppgaver/k1_oppg08.tex}%
}

\oppgaver{Standardform}{k1oppg9}{%
\input{Oppgaver/k1_oppg09.tex}%
}

\oppgaver{Signifikante siffer}{k1oppg10}{%
\input{Oppgaver/k1_oppg10.tex}%
}
