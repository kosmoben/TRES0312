...
\begin{frame}[plain]
  ...
  \begin{tikzpicture}[remember picture, overlay]
    % QR-kode til spørreundersøkelse, plassert i hjørnet nede til høyre
    % slik at den ikke overlapper forfatter/dato-teksten i midten.
    \node[anchor=south east, xshift=-0.9cm, yshift=0.5cm]
      at (current page.south east) {
        \begin{minipage}{4.4cm}
          \centering
          \includegraphics[width=4.2cm]{Images/QR_sporreundersokelse1.png}\\[3pt]
          {\tiny\color{textcolor} Spørre-\\undersøkelse}
        \end{minipage}
      };
  \end{tikzpicture}
\end{frame}
...
\begin{frame}{}
  ...
  \begin{columns}[t]
    ...
    \pause
    \begin{column}{0.42\textwidth}
      \tikz[remember picture,overlay]\node[inner sep=0pt] (kravstart) {};%
      \oppsum{Krav}{
        \begin{enumerate}[1.,itemsep=0pt,topsep=1pt]
          \item Levere øvinger på Canvas
          \item Motta veiledning fra studentassistenter.
        \end{enumerate}
      }
      \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=north east, xshift=1.3cm, yshift=-2.0cm] at (kravstart.north west) {%
          \ifdarkmode
            \includegraphics[width=3.2cm]{Images/person_undrende_mork.png}
          \else
            \includegraphics[width=3.2cm]{Images/person_undrende_lys.png}
          \fi
        };
      \end{tikzpicture}
    \end{column}
    ...
    \begin{column}{0.48\textwidth}
      \begin{center}
        \href{https://youtube.com/shorts/-g_ZOO_T-9Q?si=HxDv58107i9eZYXw}{%
          \includegraphics[width=0.6\textwidth]{Images/motivasjon_rally_thumb.png}
        }\\[0.4em]
    ...
    \begin{column}{0.48\textwidth}
      \begin{center}
        \href{https://www.youtube.com/shorts/cWmsprrRGqk}{%
          \includegraphics[width=0.6\textwidth]{Images/motivasjon_refraction_thumb.png}
        }\\[0.4em]
        {\small Klikk på bildet for å åpne videoen i nettleseren}
      \end{center}
    \end{column}
...
%--------------------------------------------------------------------------
%  SLIDE 16 — Aktivitet: gjennomsnittlig fart fra posisjonsgraf
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
%  SLIDE 18 — Aktivitet: gjennomsnittlig akselerasjon fra måledata
%--------------------------------------------------------------------------
